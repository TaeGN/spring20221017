...
<body>
	...
	<button id="btn1">/ex41/sub01 get, header 추가</button>
	<br>
	<button id="btn2">/ex41/sub02 get, header 추가</button>
	<br>
	<button id="btn3">/ex41/sub03 get, header 추가</button>
	<br>
	<button id="btn4">/ex41/sub04 get, header 변경</button>
	<br>
	<button id="btn5">/ex41/sub05 get, header 변경</button>	
